...
public interface BlogNotificationRepository extends JpaRepository<BlogNotification, Integer> {
    ...
    @Query(value = "SELECT NEW com.app.modal.BlogNotification( b.id , bn.notificationType , a.name, a.avatar,  bn.createTime, bn.id ) " +
    ...
    Page<BlogNotification> findAllByEmail(String email, Pageable pageable);
}
